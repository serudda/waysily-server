# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-03-17 06:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('active', models.BooleanField(default=False, verbose_name='YES/NO')),
                ('category', multiselectfield.db.fields.MultiSelectField(choices=[(1, 'Homestay'), (2, 'Live with a local host'), (3, 'Hostel'), (4, 'Shared Apartment'), (5, 'Private Apartment')], max_length=9, verbose_name='Type of Accommodation')),
                ('price', models.PositiveSmallIntegerField(default=0, verbose_name='Accommodation Price (USD)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terms', models.TextField(blank=True, max_length=5000, verbose_name='Terms, Details or more information')),
                ('student', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveSmallIntegerField(default=0), blank=True, help_text='Use follow format: minimum value, maximum value', size=None, verbose_name='Amount of Student per Group')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('active', models.BooleanField(default=False, verbose_name='YES/NO')),
                ('category', multiselectfield.db.fields.MultiSelectField(choices=[(1, 'Accommodation'), (2, 'Discount in classes'), (6, 'Breakfast'), (7, 'Lunch'), (8, 'Dinner')], max_length=9, verbose_name='Work Exchange Categories')),
                ('terms', models.TextField(blank=True, max_length=5000, verbose_name='Terms, Details or more information')),
